...
export function GitProfilePrintApp() {
  ...
  useEffect(() => {
    try {
      const saved = window.localStorage.getItem(`git-profile-print:${analysis.profile.username}:proofs`);
  ...
  function toggleProof(week: number, deliverable: string) {
    ...
    setCompletedProofs((current) => {
      ...
      window.localStorage.setItem(
        `git-profile-print:${analysis.profile.username}:proofs`,
        JSON.stringify(next),
      );
      return next;
    });
  ...
  function sprintMarkdown() {
    ...
    return `# Git --Profile Print Sprint\n\n**Learner:** ${analysis.profile.name} (@${analysis.profile.username})\n**Focus:** ${selectedFocus}\n**Anchor project:** ${selectedProject}\n\n## Growth thesis\n\n${analysis.headline}\n\n${analysis.summary}\n\n${weeks}\n\n---\nGenerated by Git --Profile Print with public GitHub evidence. The learner owns the final decisions.`;
  }
  ...
  function downloadSprint() {
    ...
    link.href = url;
    link.download = `${analysis.profile.username}-git-profile-print-sprint.md`;
    link.click();
  ...
  return (
    <main>
      <nav className="nav shell">
        <a className="brand" href="#top" aria-label="Git --Profile Print home">
          <span className="brand-mark">G</span>
          <span>Git --Profile Print</span>
        </a>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <p>
            Git --Profile Print reads the work in your GitHub—not a self-reported quiz—and turns it into a
      ...
      <footer className="shell">
        <div className="brand"><span className="brand-mark">G</span><span>Git --Profile Print</span></div>
