...
export function RepoBloomApp() {
  ...
  useEffect(() => {
    try {
      const saved = window.localStorage.getItem(`proofgarden:${analysis.profile.username}:proofs`);
  ...
  function toggleProof(week: number, deliverable: string) {
    ...
    setCompletedProofs((current) => {
      ...
      window.localStorage.setItem(
        `proofgarden:${analysis.profile.username}:proofs`,
        JSON.stringify(next),
      );
      return next;
    });
  ...
  function sprintMarkdown() {
    ...
    return `# ProofGarden Proof Sprint\n\n**Learner:** ${analysis.profile.name} (@${analysis.profile.username})\n**Focus:** ${selectedFocus}\n**Anchor project:** ${selectedProject}\n\n## Growth thesis\n\n${analysis.headline}\n\n${analysis.summary}\n\n${weeks}\n\n---\nGenerated by ProofGarden with public GitHub evidence. The learner owns the final decisions.`;
  }
  ...
  function downloadSprint() {
    ...
    link.href = url;
    link.download = `${analysis.profile.username}-proofgarden-sprint.md`;
    link.click();
  ...
  return (
    <main>
      <nav className="nav shell">
        <a className="brand" href="#top" aria-label="ProofGarden home">
          <span className="brand-mark">P</span>
          <span>ProofGarden</span>
        </a>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <p>
            ProofGarden reads the work in your GitHub—not a self-reported quiz—and turns it into a
      ...
      <footer className="shell">
        <div className="brand"><span className="brand-mark">P</span><span>ProofGarden</span></div>
